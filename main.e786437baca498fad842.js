...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Montserrat&family=Work+Sans:wght@300;400;500;600&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*,::after,*::before{margin:0;padding:0;-webkit-box-sizing:border-box;box-sizing:border-box}html{scroll-behavior:smooth;scroll-padding-top:var(--scroll-padding, 50px)}body{font-family:\"Work Sans\",sans-serif;background-color:#f8f9f9;line-height:1.6;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.no-scroll{overflow:hidden}.header-bg{background:radial-gradient(250.88% 493.35% at 0% 0%, #17202a 0%, #1e6b9e 65.62%, #2b85c0 100%);-webkit-box-shadow:0px 20px 40px rgba(0,0,0,.2);box-shadow:0px 20px 40px rgba(0,0,0,.2)}.container{overflow:hidden;max-width:1440px;margin:0 auto;padding:0 2rem}a{text-decoration:none}section{width:100%}.section-title{position:relative;margin-bottom:clamp(1.25rem,8vw,3.5rem);font-size:clamp(1.563rem,7vw,3.5rem);font-weight:500;color:#17202a}.section-title::after{content:\"\";position:absolute;bottom:0;left:0;width:100%;border-bottom:5px solid #1e6b9e;-webkit-transform:scale(0, 1);transform:scale(0, 1);-webkit-transform-origin:left;transform-origin:left;-webkit-transition:-webkit-transform 1.8s ease-out;transition:-webkit-transform 1.8s ease-out;transition:transform 1.8s ease-out;transition:transform 1.8s ease-out, -webkit-transform 1.8s ease-out}.section-title[data-scroll=in]::after{-webkit-transform:scale(1, 1);transform:scale(1, 1)}::-webkit-scrollbar{width:.5em}::-webkit-scrollbar-track{background-color:rgba(0,0,0,0);border-radius:100vw}::-webkit-scrollbar-thumb{background-color:#17202a;border-radius:100vw}@media screen and (max-width: 600px){.section-title::after{border-bottom-width:2px}}#header{position:fixed;top:0;left:0;z-index:999;width:100%;padding:.8rem 0;-webkit-transition:all .5s ease-in;transition:all .5s ease-in}.flex{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;height:100%}#logo{font-family:\"Montserrat\",sans-serif;font-style:italic;font-weight:400;font-size:2.75rem;color:#f8f9f9}#logo span{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex}#logo span:nth-child(1){margin-right:-10px;-webkit-transform:matrix(-1, 0, 0, 1, 0, 0);transform:matrix(-1, 0, 0, 1, 0, 0);-webkit-transition:all .5s ease;transition:all .5s ease}#logo span:nth-child(even){overflow:hidden;font-style:normal;-webkit-animation:logo 1s ease;animation:logo 1s ease;letter-spacing:-1em;-webkit-transition:all .5s ease .5s;transition:all .5s ease .5s}#logo:hover span:nth-child(1){margin-right:0;-webkit-transform:matrix(1, 0, 0, 1, 0, 0);transform:matrix(1, 0, 0, 1, 0, 0)}#logo:hover span:nth-child(even){letter-spacing:-0.03em}.nav-links{position:relative;display:-webkit-box;display:-ms-flexbox;display:flex;list-style-type:none}.nav-links li:not(:last-child){padding-right:2rem}.nav-link:not(.btn-outline-primary){position:relative;padding-bottom:.5rem;font-size:1.25rem;font-weight:500;color:#f8f9f9}.nav-link:not(.btn-outline-primary)::after{content:\"\";position:absolute;bottom:0;left:0;width:100%;border-bottom:2px solid #f8f9f9;-webkit-transform:scale(0, 1);transform:scale(0, 1);-webkit-transform-origin:right;transform-origin:right;-webkit-transition:-webkit-transform .3s ease-out;transition:-webkit-transform .3s ease-out;transition:transform .3s ease-out;transition:transform .3s ease-out, -webkit-transform .3s ease-out}.nav-link:not(.btn-outline-primary):hover::after{-webkit-transform:scale(1, 1);transform:scale(1, 1);-webkit-transform-origin:left;transform-origin:left}.nav-link:not(.btn-outline-primary).nav-active::after{-webkit-transform:scale(1, 1);transform:scale(1, 1);-webkit-transform-origin:left;transform-origin:left}@media screen and (max-width: 768px){.nav-links{position:fixed;top:0;left:0;-ms-flex-pack:distribute;justify-content:space-around;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;width:100%;height:100vh;padding:8rem 0;background:radial-gradient(250.88% 493.35% at 0% 0%, #17202a 0%, #1e6b9e 65.62%, #2b85c0 100%);-webkit-clip-path:circle(100px at 100% -20%);clip-path:circle(100px at 100% -20%);-webkit-transition:all 1s ease-in-out;transition:all 1s ease-in-out;pointer-events:none}.nav-links li{opacity:0;width:100%;text-align:center;-webkit-transform:translateX(100%);transform:translateX(100%);-webkit-transition:-webkit-transform .5s ease-in-out 1s;transition:-webkit-transform .5s ease-in-out 1s;transition:transform .5s ease-in-out 1s;transition:transform .5s ease-in-out 1s, -webkit-transform .5s ease-in-out 1s}.nav-links li:nth-of-type(1){-webkit-transition-delay:.7s;transition-delay:.7s}.nav-links li:nth-of-type(2){-webkit-transition-delay:.8s;transition-delay:.8s}.nav-links li:nth-of-type(3){-webkit-transition-delay:.9s;transition-delay:.9s}.nav-links li:nth-of-type(4){-webkit-transition-delay:1s;transition-delay:1s}.nav-links li.move{opacity:1;-webkit-transform:translateX(0);transform:translateX(0)}.nav-links li:not(:last-child){padding-right:0}.nav-links li:nth-child(3){margin-bottom:1rem}.nav-links.open{-webkit-clip-path:circle(100% at center);clip-path:circle(100% at center);pointer-events:all}.nav-link:not(.btn-outline-primary){padding-bottom:0;font-size:1.5rem}}@media screen and (max-width: 600px){#logo{font-size:2.25rem}}@media(hover: none){.nav-link:not(.btn-outline-primary)::after{border-bottom-width:0}#logo span:nth-child(1){-webkit-transform:matrix(-1, 0, 0, 1, 0, 0);transform:matrix(-1, 0, 0, 1, 0, 0)}#logo span:nth-child(even){letter-spacing:-1em}}#index{position:relative;padding-top:var(--scroll-padding, 50px);min-height:100vh;background:radial-gradient(250.88% 493.35% at 0% 0%, #17202a 0%, #1e6b9e 65.62%, #2b85c0 100%)}#index h4{font-size:clamp(.8rem,3.5vw,1.85rem);font-weight:300;color:#e5e5e5;letter-spacing:-0.07em}#index h1{margin-bottom:.5rem;font-size:clamp(2rem,8vw,4.5rem);font-weight:600;color:#f0f0c9;line-height:clamp(34px,8vw,84px);letter-spacing:-0.07em}#index h1 span{display:block}#index p{margin-bottom:2.2rem;font-size:clamp(1.125rem,4vw,2rem);font-weight:400;color:#e5e5e5;line-height:clamp(22px,4vw,42px)}#index p span{display:block}#index .mail-icon{margin-right:.5rem;font-size:1.25rem;color:#17202a}#index svg{position:absolute;right:0;bottom:0;width:630px;max-width:100%;height:auto;-o-object-fit:cover;object-fit:cover}#context{-webkit-animation:context 1s linear infinite both;animation:context 1s linear infinite both}#man{-webkit-animation:man 3s linear infinite;animation:man 3s linear infinite}@-webkit-keyframes man{0%,100%{opacity:1}41.99%{opacity:1}42%{opacity:0}43%{opacity:0}43.01%{opacity:1}45.99%{opacity:1}46%{opacity:0}46.9%{opacity:0}46.91%{opacity:1}51.99%{opacity:1}52%{opacity:0}52.8%{opacity:0}52.81%{opacity:1}}@keyframes man{0%,100%{opacity:1}41.99%{opacity:1}42%{opacity:0}43%{opacity:0}43.01%{opacity:1}45.99%{opacity:1}46%{opacity:0}46.9%{opacity:0}46.91%{opacity:1}51.99%{opacity:1}52%{opacity:0}52.8%{opacity:0}52.81%{opacity:1}}@-webkit-keyframes context{0%{-webkit-transform:translate(0);transform:translate(0)}20%{-webkit-transform:translate(-2px, 2px);transform:translate(-2px, 2px)}40%{-webkit-transform:translate(-2px, -2px);transform:translate(-2px, -2px)}60%{-webkit-transform:translate(2px, 2px);transform:translate(2px, 2px)}80%{-webkit-transform:translate(2px, -2px);transform:translate(2px, -2px)}100%{-webkit-transform:translate(0);transform:translate(0)}}@keyframes context{0%{-webkit-transform:translate(0);transform:translate(0)}20%{-webkit-transform:translate(-2px, 2px);transform:translate(-2px, 2px)}40%{-webkit-transform:translate(-2px, -2px);transform:translate(-2px, -2px)}60%{-webkit-transform:translate(2px, 2px);transform:translate(2px, 2px)}80%{-webkit-transform:translate(2px, -2px);transform:translate(2px, -2px)}100%{-webkit-transform:translate(0);transform:translate(0)}}@media screen and (min-width: 1921px){#index{padding-top:20rem}#index svg{width:1300px}}@media screen and (max-width: 1440px){#index svg{width:600px}}@media screen and (max-width: 1280px){#index .mail-icon{font-size:1.125rem}}@media screen and (max-width: 768px){#index p{margin-bottom:1.5rem}}@media screen and (max-width: 600px){#index{padding-top:6.5rem}#index svg{opacity:.7}}@media screen and (max-width: 480px){#index svg{opacity:1}}@media screen and (max-width: 320px){#index h1{font-size:1.75rem}#index svg{width:300px;opacity:.3}#index .mail-icon{font-size:.875rem}}#projects{margin:3rem 0}#projects .project{margin-bottom:1.5rem}#projects .project img{width:100%;max-width:100%;height:auto;-o-object-fit:cover;object-fit:cover;margin-bottom:1.75rem;background:radial-gradient(136.17% 288.39% at -14.09% -13.71%, #17202a 0%, #1e6b9e 71.35%, #2b85c0 100%);border-radius:5px}#projects .project .project-title{font-size:clamp(1.125rem,6vw,3rem);font-weight:400;white-space:nowrap;color:#17202a}#projects .project .project-desc{margin-bottom:clamp(.5rem,4vw,1.5rem);font-size:clamp(.938rem,4vw,1.5rem);font-weight:300;line-height:32px;color:#17202a}#projects .project .project-desc span{display:block}#projects .project .contributions{margin-bottom:2rem;white-space:nowrap}#projects .project .contributions span{padding:.5em 1em;font-size:clamp(.64rem,2vw,.9rem);font-weight:400;text-transform:uppercase;white-space:nowrap;background-color:#f0f0c9;color:#17202a;border-radius:20px}#projects .project .contributions span:nth-child(2){margin:0 .3rem}#projects .project .project-links{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-ms-flex-wrap:wrap;flex-wrap:wrap}#projects .project .project-links a:first-child{margin-right:4rem}@media screen and (max-width: 768px){#projects .project .project-desc span{display:inline}}@media screen and (max-width: 600px){#projects .project .project-desc{line-height:normal}#projects .project .project-links{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}#projects .project .project-links a:first-child{margin-right:0;margin-bottom:1.2rem}#projects .project .project-links a i{font-size:1rem}}#about{margin-bottom:5rem}#about .profile{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;margin-bottom:clamp(1.5rem,8vw,8rem)}#about .profile img{width:400px;max-width:100%;height:auto;-o-object-fit:cover;object-fit:cover;margin-right:4rem}#about .profile .details p{margin-bottom:1.5rem;font-size:2rem;font-weight:300;color:#17202a;line-height:42px}#about .profile .details p span{display:block}#about .profile .details a{font-weight:500}#about .skills{margin-bottom:clamp(1.5rem,8vw,5rem)}#about .skills h2{margin-bottom:1rem;font-size:clamp(1.5rem,6vw,3rem);font-weight:500;white-space:nowrap;color:#17202a}#about .skills p{font-size:clamp(1rem,5vw,2rem);font-weight:300;color:#17202a;line-height:42px}#about .skills p span{display:block}#about .awards h2{margin-bottom:1rem;font-size:clamp(1.25rem,6vw,3rem);font-weight:500;color:#17202a}#about .awards .awards-link{list-style-type:none}#about .awards .awards-link li a{font-size:clamp(1rem,5vw,2rem);font-weight:300;color:#17202a;-webkit-transition:color .3s ease-out;transition:color .3s ease-out}#about .awards .awards-link li a:hover{color:#1e6b9e}@media screen and (max-width: 1280px){#about .profile{-ms-flex-wrap:wrap;flex-wrap:wrap}#about .profile img{width:350px;margin-bottom:1.5rem}#about .profile .details p{font-size:1.75rem}}@media screen and (max-width: 768px){#about .profile img{margin-right:0}#about .profile .details p{font-size:1.563rem}#about .skills p{line-height:normal}#about .skills p span{display:inline}}@media screen and (max-width: 600px){#about .profile img{width:280px}#about .profile .details p{font-size:1.125rem;line-height:normal}#about .profile .details p span{display:inline}}@media(hover: none){#about .awards .awards-link li a{color:#17202a}}#contact{padding:4rem 0;background:radial-gradient(250.88% 493.35% at 0% 0%, #17202a 0%, #1e6b9e 65.62%, #2b85c0 100%)}#contact h4{font-size:clamp(1.25rem,4vw,3rem);font-weight:300;text-align:center;color:#f0f0c9}#contact h1{position:relative;margin-bottom:1rem;padding-bottom:clamp(1rem,5vw,3.5rem);font-size:clamp(1.4rem,6vw,6rem);font-weight:500;text-align:center;word-wrap:break-word;letter-spacing:-0.075em}#contact h1 a{color:#f8f9f9;-webkit-transition:color .3s ease-out;transition:color .3s ease-out}#contact h1 a:hover{color:#85c1e9}#contact h1::after{content:\"\";position:absolute;bottom:0;left:0;width:100%;border-bottom:5px solid #85c1e9;-webkit-transform:scale(0, 1);transform:scale(0, 1);-webkit-transform-origin:left;transform-origin:left;-webkit-transition:-webkit-transform 1.5s ease-out;transition:-webkit-transform 1.5s ease-out;transition:transform 1.5s ease-out;transition:transform 1.5s ease-out, -webkit-transform 1.5s ease-out}#contact h1[data-scroll=in]::after{-webkit-transform:scale(1, 1);transform:scale(1, 1)}@media screen and (max-width: 600px){#contact h1::after{border-bottom-width:2px}}@media(hover: none){#contact h1 a{color:#f8f9f9}}#footer{width:100%}#footer .flex-footer{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;font-family:\"Montserrat\",sans-serif}#footer .flex-footer .copyright{font-size:clamp(1rem,4vw,1.5rem);font-weight:300;letter-spacing:-1.2px;color:#f8f9f9}#footer .flex-footer .copyright span{font-style:italic}#footer .flex-footer .social-links{display:-webkit-box;display:-ms-flexbox;display:flex;font-size:clamp(1rem,4vw,1.25rem);font-weight:300;letter-spacing:-1.2px;color:#f8f9f9}#footer .flex-footer .social-links li{-webkit-transition:color .3s ease-out;transition:color .3s ease-out}#footer .flex-footer .social-links li a{color:#f8f9f9;-webkit-transition:color .3s ease-out;transition:color .3s ease-out}#footer .flex-footer .social-links li a:hover{color:#85c1e9}#footer .flex-footer .social-links li:hover{color:#85c1e9}#footer .flex-footer .social-links li:not(:last-child){padding-right:2rem;margin-right:.5rem}@media screen and (max-width: 768px){#footer .flex-footer{-webkit-box-orient:vertical;-webkit-box-direction:reverse;-ms-flex-direction:column-reverse;flex-direction:column-reverse}#footer .flex-footer .social-links{margin-bottom:1rem}}@media screen and (max-width: 600px){#footer .flex-footer{-webkit-box-pack:start;-ms-flex-pack:start;justify-content:flex-start;-webkit-box-align:start;-ms-flex-align:start;align-items:flex-start}#footer .flex-footer .social-links{display:block;margin-left:1.5rem}#footer .flex-footer .social-links li{margin-bottom:1rem}}@media(hover: none){#footer .flex-footer .social-links li{color:#f8f9f9}#footer .flex-footer .social-links li a{color:#f8f9f9}}.btn-outline-primary{position:relative;overflow:hidden;z-index:1;padding:.65em 1.25em;font-size:1.25rem;font-weight:500;white-space:nowrap;color:#85c1e9;border:2px solid #85c1e9;border-radius:5px;-webkit-box-shadow:inset 0 0 0 0 #f0f0c9;box-shadow:inset 0 0 0 0 #f0f0c9;-webkit-transition:all .5s ease-out;transition:all .5s ease-out}.btn-outline-primary:hover{color:#17202a;-webkit-box-shadow:inset 0 -100px 0 0 #f0f0c9;box-shadow:inset 0 -100px 0 0 #f0f0c9;border-color:#f0f0c9}.btn-primary{position:relative;overflow:hidden;z-index:1;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;padding:.65em 1.25em;font-size:1.25rem;font-weight:500;white-space:nowrap;background-color:#f0f0c9;color:#17202a;border-radius:5px;-webkit-transition:-webkit-transform .3s ease-out;transition:-webkit-transform .3s ease-out;transition:transform .3s ease-out;transition:transform .3s ease-out, -webkit-transform .3s ease-out}.btn-primary:hover{-webkit-transform:translateY(-7px);transform:translateY(-7px)}.btn-link{position:relative;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;font-size:1.25rem;font-weight:400;white-space:nowrap;color:#17202a}.btn-link span{margin-right:.5rem}.btn-link::after{content:\"\";position:absolute;bottom:0;left:0;width:100%;border-bottom:2px solid #17202a;-webkit-transform:scale(0, 1);transform:scale(0, 1);-webkit-transform-origin:right;transform-origin:right;-webkit-transition:-webkit-transform .3s ease-out;transition:-webkit-transform .3s ease-out;transition:transform .3s ease-out;transition:transform .3s ease-out, -webkit-transform .3s ease-out}.btn-link:hover::after{-webkit-transform:scale(1, 1);transform:scale(1, 1);-webkit-transform-origin:left;transform-origin:left}.btn-link i{font-size:1.25rem;-webkit-transition:-webkit-transform .3s ease;transition:-webkit-transform .3s ease;transition:transform .3s ease;transition:transform .3s ease, -webkit-transform .3s ease}.btn-link:hover i{-webkit-transform:translateX(5px);transform:translateX(5px)}@media screen and (max-width: 1280px){.btn-primary,.btn-link{font-size:1.125rem}}@media screen and (max-width: 768px){.btn-primary,.btn-link{font-size:1rem}}@media screen and (max-width: 320px){.btn-primary,.btn-link{font-size:.875rem}}@media(hover: none){.btn-link::after{border-bottom-width:0}.btn-outline-primary{color:#85c1e9;-webkit-box-shadow:inset 0 0 0 0 #f0f0c9;box-shadow:inset 0 0 0 0 #f0f0c9;border-color:#85c1e9}}/*!\n * Hamburgers\n * @description Tasty CSS-animated hamburgers\n * @author Jonathan Suh @jonsuh\n * @site https://jonsuh.com/hamburgers\n * @link https://github.com/jonsuh/hamburgers\n */.hamburger{overflow:visible;display:none;margin:0;font:inherit;background-color:rgba(0,0,0,0);color:inherit;text-transform:none;border:0;cursor:pointer;-webkit-transition-property:opacity,-webkit-filter;transition-property:opacity,-webkit-filter;transition-property:opacity,filter;transition-property:opacity,filter,-webkit-filter;-webkit-transition-duration:.15s;transition-duration:.15s;-webkit-transition-timing-function:linear;transition-timing-function:linear}.hamburger:hover{opacity:.7}.hamburger.is-active:hover{opacity:.7}.hamburger.is-active .hamburger-inner,.hamburger.is-active .hamburger-inner::before,.hamburger.is-active .hamburger-inner::after{background-color:#f8f9f9}.hamburger-box{position:relative;width:35px;height:24px}.hamburger-inner{display:block;top:50%;margin-top:-2px}.hamburger-inner,.hamburger-inner::before,.hamburger-inner::after{position:absolute;width:35px;height:4px;background-color:#f8f9f9;border-radius:4px;-webkit-transition:-webkit-transform .15s ease;transition:-webkit-transform .15s ease;transition:transform .15s ease;transition:transform .15s ease, -webkit-transform .15s ease}.hamburger-inner::before,.hamburger-inner::after{content:\"\";display:block}.hamburger-inner::before{top:-10px}.hamburger-inner::after{bottom:-10px}.hamburger--collapse .hamburger-inner{top:auto;bottom:0;-webkit-transition-duration:.13s;transition-duration:.13s;-webkit-transition-delay:.13s;transition-delay:.13s;-webkit-transition-timing-function:cubic-bezier(0.55, 0.055, 0.675, 0.19);transition-timing-function:cubic-bezier(0.55, 0.055, 0.675, 0.19)}.hamburger--collapse .hamburger-inner::after{top:-20px;-webkit-transition:top .2s .2s cubic-bezier(0.33333, 0.66667, 0.66667, 1),opacity .1s linear;transition:top .2s .2s cubic-bezier(0.33333, 0.66667, 0.66667, 1),opacity .1s linear}.hamburger--collapse .hamburger-inner::before{-webkit-transition:top .12s .2s cubic-bezier(0.33333, 0.66667, 0.66667, 1),-webkit-transform .13s cubic-bezier(0.55, 0.055, 0.675, 0.19);transition:top .12s .2s cubic-bezier(0.33333, 0.66667, 0.66667, 1),-webkit-transform .13s cubic-bezier(0.55, 0.055, 0.675, 0.19);transition:top .12s .2s cubic-bezier(0.33333, 0.66667, 0.66667, 1),transform .13s cubic-bezier(0.55, 0.055, 0.675, 0.19);transition:top .12s .2s cubic-bezier(0.33333, 0.66667, 0.66667, 1),transform .13s cubic-bezier(0.55, 0.055, 0.675, 0.19),-webkit-transform .13s cubic-bezier(0.55, 0.055, 0.675, 0.19)}.hamburger--collapse.is-active .hamburger-inner{-webkit-transform:translate3d(0, -10px, 0) rotate(-45deg);transform:translate3d(0, -10px, 0) rotate(-45deg);-webkit-transition-delay:.22s;transition-delay:.22s;-webkit-transition-timing-function:cubic-bezier(0.215, 0.61, 0.355, 1);transition-timing-function:cubic-bezier(0.215, 0.61, 0.355, 1)}.hamburger--collapse.is-active .hamburger-inner::after{top:0;opacity:0;-webkit-transition:top .2s cubic-bezier(0.33333, 0, 0.66667, 0.33333),opacity .1s .22s linear;transition:top .2s cubic-bezier(0.33333, 0, 0.66667, 0.33333),opacity .1s .22s linear}.hamburger--collapse.is-active .hamburger-inner::before{top:0;-webkit-transform:rotate(-90deg);transform:rotate(-90deg);-webkit-transition:top .1s .16s cubic-bezier(0.33333, 0, 0.66667, 0.33333),-webkit-transform .13s .25s cubic-bezier(0.215, 0.61, 0.355, 1);transition:top .1s .16s cubic-bezier(0.33333, 0, 0.66667, 0.33333),-webkit-transform .13s .25s cubic-bezier(0.215, 0.61, 0.355, 1);transition:top .1s .16s cubic-bezier(0.33333, 0, 0.66667, 0.33333),transform .13s .25s cubic-bezier(0.215, 0.61, 0.355, 1);transition:top .1s .16s cubic-bezier(0.33333, 0, 0.66667, 0.33333),transform .13s .25s cubic-bezier(0.215, 0.61, 0.355, 1),-webkit-transform .13s .25s cubic-bezier(0.215, 0.61, 0.355, 1)}@media screen and (max-width: 768px){.hamburger{display:inline-block}}@media screen and (max-width: 600px){.hamburger-inner,.hamburger-inner::before,.hamburger-inner::after{width:30px;height:3px}}[data-sal]{-webkit-transition-delay:0s;transition-delay:0s;-webkit-transition-delay:var(--sal-delay, 0s);transition-delay:var(--sal-delay, 0s);-webkit-transition-duration:.2s;transition-duration:.2s;-webkit-transition-duration:var(--sal-duration, 0.2s);transition-duration:var(--sal-duration, 0.2s);-webkit-transition-timing-function:ease;transition-timing-function:ease;-webkit-transition-timing-function:var(--sal-easing, ease);transition-timing-function:var(--sal-easing, ease)}[data-sal][data-sal-duration=\"200\"]{-webkit-transition-duration:.2s;transition-duration:.2s}[data-sal][data-sal-duration=\"250\"]{-webkit-transition-duration:.25s;transition-duration:.25s}[data-sal][data-sal-duration=\"300\"]{-webkit-transition-duration:.3s;transition-duration:.3s}[data-sal][data-sal-duration=\"350\"]{-webkit-transition-duration:.35s;transition-duration:.35s}[data-sal][data-sal-duration=\"400\"]{-webkit-transition-duration:.4s;transition-duration:.4s}[data-sal][data-sal-duration=\"450\"]{-webkit-transition-duration:.45s;transition-duration:.45s}[data-sal][data-sal-duration=\"500\"]{-webkit-transition-duration:.5s;transition-duration:.5s}[data-sal][data-sal-duration=\"550\"]{-webkit-transition-duration:.55s;transition-duration:.55s}[data-sal][data-sal-duration=\"600\"]{-webkit-transition-duration:.6s;transition-duration:.6s}[data-sal][data-sal-duration=\"650\"]{-webkit-transition-duration:.65s;transition-duration:.65s}[data-sal][data-sal-duration=\"700\"]{-webkit-transition-duration:.7s;transition-duration:.7s}[data-sal][data-sal-duration=\"750\"]{-webkit-transition-duration:.75s;transition-duration:.75s}[data-sal][data-sal-duration=\"800\"]{-webkit-transition-duration:.8s;transition-duration:.8s}[data-sal][data-sal-duration=\"850\"]{-webkit-transition-duration:.85s;transition-duration:.85s}[data-sal][data-sal-duration=\"900\"]{-webkit-transition-duration:.9s;transition-duration:.9s}[data-sal][data-sal-duration=\"950\"]{-webkit-transition-duration:.95s;transition-duration:.95s}[data-sal][data-sal-duration=\"1000\"]{-webkit-transition-duration:1s;transition-duration:1s}[data-sal][data-sal-duration=\"1050\"]{-webkit-transition-duration:1.05s;transition-duration:1.05s}[data-sal][data-sal-duration=\"1100\"]{-webkit-transition-duration:1.1s;transition-duration:1.1s}[data-sal][data-sal-duration=\"1150\"]{-webkit-transition-duration:1.15s;transition-duration:1.15s}[data-sal][data-sal-duration=\"1200\"]{-webkit-transition-duration:1.2s;transition-duration:1.2s}[data-sal][data-sal-duration=\"1250\"]{-webkit-transition-duration:1.25s;transition-duration:1.25s}[data-sal][data-sal-duration=\"1300\"]{-webkit-transition-duration:1.3s;transition-duration:1.3s}[data-sal][data-sal-duration=\"1350\"]{-webkit-transition-duration:1.35s;transition-duration:1.35s}[data-sal][data-sal-duration=\"1400\"]{-webkit-transition-duration:1.4s;transition-duration:1.4s}[data-sal][data-sal-duration=\"1450\"]{-webkit-transition-duration:1.45s;transition-duration:1.45s}[data-sal][data-sal-duration=\"1500\"]{-webkit-transition-duration:1.5s;transition-duration:1.5s}[data-sal][data-sal-duration=\"1550\"]{-webkit-transition-duration:1.55s;transition-duration:1.55s}[data-sal][data-sal-duration=\"1600\"]{-webkit-transition-duration:1.6s;transition-duration:1.6s}[data-sal][data-sal-duration=\"1650\"]{-webkit-transition-duration:1.65s;transition-duration:1.65s}[data-sal][data-sal-duration=\"1700\"]{-webkit-transition-duration:1.7s;transition-duration:1.7s}[data-sal][data-sal-duration=\"1750\"]{-webkit-transition-duration:1.75s;transition-duration:1.75s}[data-sal][data-sal-duration=\"1800\"]{-webkit-transition-duration:1.8s;transition-duration:1.8s}[data-sal][data-sal-duration=\"1850\"]{-webkit-transition-duration:1.85s;transition-duration:1.85s}[data-sal][data-sal-duration=\"1900\"]{-webkit-transition-duration:1.9s;transition-duration:1.9s}[data-sal][data-sal-duration=\"1950\"]{-webkit-transition-duration:1.95s;transition-duration:1.95s}[data-sal][data-sal-duration=\"2000\"]{-webkit-transition-duration:2s;transition-duration:2s}[data-sal][data-sal-delay=\"50\"]{-webkit-transition-delay:.05s;transition-delay:.05s}[data-sal][data-sal-delay=\"100\"]{-webkit-transition-delay:.1s;transition-delay:.1s}[data-sal][data-sal-delay=\"150\"]{-webkit-transition-delay:.15s;transition-delay:.15s}[data-sal][data-sal-delay=\"200\"]{-webkit-transition-delay:.2s;transition-delay:.2s}[data-sal][data-sal-delay=\"250\"]{-webkit-transition-delay:.25s;transition-delay:.25s}[data-sal][data-sal-delay=\"300\"]{-webkit-transition-delay:.3s;transition-delay:.3s}[data-sal][data-sal-delay=\"350\"]{-webkit-transition-delay:.35s;transition-delay:.35s}[data-sal][data-sal-delay=\"400\"]{-webkit-transition-delay:.4s;transition-delay:.4s}[data-sal][data-sal-delay=\"450\"]{-webkit-transition-delay:.45s;transition-delay:.45s}[data-sal][data-sal-delay=\"500\"]{-webkit-transition-delay:.5s;transition-delay:.5s}[data-sal][data-sal-delay=\"550\"]{-webkit-transition-delay:.55s;transition-delay:.55s}[data-sal][data-sal-delay=\"600\"]{-webkit-transition-delay:.6s;transition-delay:.6s}[data-sal][data-sal-delay=\"650\"]{-webkit-transition-delay:.65s;transition-delay:.65s}[data-sal][data-sal-delay=\"700\"]{-webkit-transition-delay:.7s;transition-delay:.7s}[data-sal][data-sal-delay=\"750\"]{-webkit-transition-delay:.75s;transition-delay:.75s}[data-sal][data-sal-delay=\"800\"]{-webkit-transition-delay:.8s;transition-delay:.8s}[data-sal][data-sal-delay=\"850\"]{-webkit-transition-delay:.85s;transition-delay:.85s}[data-sal][data-sal-delay=\"900\"]{-webkit-transition-delay:.9s;transition-delay:.9s}[data-sal][data-sal-delay=\"950\"]{-webkit-transition-delay:.95s;transition-delay:.95s}[data-sal][data-sal-delay=\"1000\"]{-webkit-transition-delay:1s;transition-delay:1s}[data-sal][data-sal-easing=linear]{-webkit-transition-timing-function:linear;transition-timing-function:linear}[data-sal][data-sal-easing=ease]{-webkit-transition-timing-function:ease;transition-timing-function:ease}[data-sal][data-sal-easing=ease-in]{-webkit-transition-timing-function:ease-in;transition-timing-function:ease-in}[data-sal][data-sal-easing=ease-out]{-webkit-transition-timing-function:ease-out;transition-timing-function:ease-out}[data-sal][data-sal-easing=ease-in-out]{-webkit-transition-timing-function:ease-in-out;transition-timing-function:ease-in-out}[data-sal][data-sal-easing=ease-in-cubic]{-webkit-transition-timing-function:cubic-bezier(0.55, 0.055, 0.675, 0.19);transition-timing-function:cubic-bezier(0.55, 0.055, 0.675, 0.19)}[data-sal][data-sal-easing=ease-out-cubic]{-webkit-transition-timing-function:cubic-bezier(0.215, 0.61, 0.355, 1);transition-timing-function:cubic-bezier(0.215, 0.61, 0.355, 1)}[data-sal][data-sal-easing=ease-in-out-cubic]{-webkit-transition-timing-function:cubic-bezier(0.645, 0.045, 0.355, 1);transition-timing-function:cubic-bezier(0.645, 0.045, 0.355, 1)}[data-sal][data-sal-easing=ease-in-circ]{-webkit-transition-timing-function:cubic-bezier(0.6, 0.04, 0.98, 0.335);transition-timing-function:cubic-bezier(0.6, 0.04, 0.98, 0.335)}[data-sal][data-sal-easing=ease-out-circ]{-webkit-transition-timing-function:cubic-bezier(0.075, 0.82, 0.165, 1);transition-timing-function:cubic-bezier(0.075, 0.82, 0.165, 1)}[data-sal][data-sal-easing=ease-in-out-circ]{-webkit-transition-timing-function:cubic-bezier(0.785, 0.135, 0.15, 0.86);transition-timing-function:cubic-bezier(0.785, 0.135, 0.15, 0.86)}[data-sal][data-sal-easing=ease-in-expo]{-webkit-transition-timing-function:cubic-bezier(0.95, 0.05, 0.795, 0.035);transition-timing-function:cubic-bezier(0.95, 0.05, 0.795, 0.035)}[data-sal][data-sal-easing=ease-out-expo]{-webkit-transition-timing-function:cubic-bezier(0.19, 1, 0.22, 1);transition-timing-function:cubic-bezier(0.19, 1, 0.22, 1)}[data-sal][data-sal-easing=ease-in-out-expo]{-webkit-transition-timing-function:cubic-bezier(1, 0, 0, 1);transition-timing-function:cubic-bezier(1, 0, 0, 1)}[data-sal][data-sal-easing=ease-in-quad]{-webkit-transition-timing-function:cubic-bezier(0.55, 0.085, 0.68, 0.53);transition-timing-function:cubic-bezier(0.55, 0.085, 0.68, 0.53)}[data-sal][data-sal-easing=ease-out-quad]{-webkit-transition-timing-function:cubic-bezier(0.25, 0.46, 0.45, 0.94);transition-timing-function:cubic-bezier(0.25, 0.46, 0.45, 0.94)}[data-sal][data-sal-easing=ease-in-out-quad]{-webkit-transition-timing-function:cubic-bezier(0.455, 0.03, 0.515, 0.955);transition-timing-function:cubic-bezier(0.455, 0.03, 0.515, 0.955)}[data-sal][data-sal-easing=ease-in-quart]{-webkit-transition-timing-function:cubic-bezier(0.895, 0.03, 0.685, 0.22);transition-timing-function:cubic-bezier(0.895, 0.03, 0.685, 0.22)}[data-sal][data-sal-easing=ease-out-quart]{-webkit-transition-timing-function:cubic-bezier(0.165, 0.84, 0.44, 1);transition-timing-function:cubic-bezier(0.165, 0.84, 0.44, 1)}[data-sal][data-sal-easing=ease-in-out-quart]{-webkit-transition-timing-function:cubic-bezier(0.77, 0, 0.175, 1);transition-timing-function:cubic-bezier(0.77, 0, 0.175, 1)}[data-sal][data-sal-easing=ease-in-quint]{-webkit-transition-timing-function:cubic-bezier(0.755, 0.05, 0.855, 0.06);transition-timing-function:cubic-bezier(0.755, 0.05, 0.855, 0.06)}[data-sal][data-sal-easing=ease-out-quint]{-webkit-transition-timing-function:cubic-bezier(0.23, 1, 0.32, 1);transition-timing-function:cubic-bezier(0.23, 1, 0.32, 1)}[data-sal][data-sal-easing=ease-in-out-quint]{-webkit-transition-timing-function:cubic-bezier(0.86, 0, 0.07, 1);transition-timing-function:cubic-bezier(0.86, 0, 0.07, 1)}[data-sal][data-sal-easing=ease-in-sine]{-webkit-transition-timing-function:cubic-bezier(0.47, 0, 0.745, 0.715);transition-timing-function:cubic-bezier(0.47, 0, 0.745, 0.715)}[data-sal][data-sal-easing=ease-out-sine]{-webkit-transition-timing-function:cubic-bezier(0.39, 0.575, 0.565, 1);transition-timing-function:cubic-bezier(0.39, 0.575, 0.565, 1)}[data-sal][data-sal-easing=ease-in-out-sine]{-webkit-transition-timing-function:cubic-bezier(0.445, 0.05, 0.55, 0.95);transition-timing-function:cubic-bezier(0.445, 0.05, 0.55, 0.95)}[data-sal][data-sal-easing=ease-in-back]{-webkit-transition-timing-function:cubic-bezier(0.6, -0.28, 0.735, 0.045);transition-timing-function:cubic-bezier(0.6, -0.28, 0.735, 0.045)}[data-sal][data-sal-easing=ease-out-back]{-webkit-transition-timing-function:cubic-bezier(0.175, 0.885, 0.32, 1.275);transition-timing-function:cubic-bezier(0.175, 0.885, 0.32, 1.275)}[data-sal][data-sal-easing=ease-in-out-back]{-webkit-transition-timing-function:cubic-bezier(0.68, -0.55, 0.265, 1.55);transition-timing-function:cubic-bezier(0.68, -0.55, 0.265, 1.55)}[data-sal|=fade]{opacity:0;-webkit-transition-property:opacity;transition-property:opacity}[data-sal|=fade].sal-animate,body.sal-disabled [data-sal|=fade]{opacity:1}[data-sal|=slide]{opacity:0;-webkit-transition-property:opacity,-webkit-transform;transition-property:opacity,-webkit-transform;transition-property:opacity,transform;transition-property:opacity,transform,-webkit-transform}[data-sal=slide-up]{-webkit-transform:translateY(20%);transform:translateY(20%)}[data-sal=slide-down]{-webkit-transform:translateY(-20%);transform:translateY(-20%)}[data-sal=slide-left]{-webkit-transform:translateX(20%);transform:translateX(20%)}[data-sal=slide-right]{-webkit-transform:translateX(-20%);transform:translateX(-20%)}[data-sal|=slide].sal-animate,body.sal-disabled [data-sal|=slide]{opacity:1;-webkit-transform:none;transform:none}[data-sal|=zoom]{opacity:0;-webkit-transition-property:opacity,-webkit-transform;transition-property:opacity,-webkit-transform;transition-property:opacity,transform;transition-property:opacity,transform,-webkit-transform}[data-sal=zoom-in]{-webkit-transform:scale(0.5);transform:scale(0.5)}[data-sal=zoom-out]{-webkit-transform:scale(1.1);transform:scale(1.1)}[data-sal|=zoom].sal-animate,body.sal-disabled [data-sal|=zoom]{opacity:1;-webkit-transform:none;transform:none}[data-sal|=flip]{-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-transition-property:-webkit-transform;transition-property:-webkit-transform;transition-property:transform;transition-property:transform, -webkit-transform}[data-sal=flip-left]{-webkit-transform:perspective(2000px) rotateY(-91deg);transform:perspective(2000px) rotateY(-91deg)}[data-sal=flip-right]{-webkit-transform:perspective(2000px) rotateY(91deg);transform:perspective(2000px) rotateY(91deg)}[data-sal=flip-up]{-webkit-transform:perspective(2000px) rotateX(-91deg);transform:perspective(2000px) rotateX(-91deg)}[data-sal=flip-down]{-webkit-transform:perspective(2000px) rotateX(91deg);transform:perspective(2000px) rotateX(91deg)}[data-sal|=flip].sal-animate,body.sal-disabled [data-sal|=flip]{-webkit-transform:none;transform:none}", "",{"version":3,"sources":["webpack://./src/assets/scss/base/_resets.scss","webpack://./src/assets/scss/abstracts/_variables.scss","webpack://./src/assets/scss/components/_media.scss","webpack://./src/assets/scss/layout/_header.scss","webpack://./src/assets/scss/abstracts/_mixins.scss","webpack://./src/assets/scss/pages/_home.scss","webpack://./src/assets/scss/pages/_projects.scss","webpack://./src/assets/scss/pages/_about.scss","webpack://./src/assets/scss/pages/_contact.scss","webpack://./src/assets/scss/layout/_footer.scss","webpack://./src/assets/scss/components/_buttons.scss","webpack://./src/assets/scss/vendor/_hamburgers.scss","webpack://./src/assets/scss/vendor/_sal.scss"],"names":[],"mappings":"AAIA,oBACE,QAAA,CACA,SAAA,CACA,6BAAA,CAAA,qBAAA,CAWF,KACE,sBAAA,CACA,8CAAA,CAGF,KACE
BAAA,CAEF,sBACE,iCAAA,CAAA,yBAAA,CAEF,uBACE,kCAAA,CAAA,0BAAA,CAEF,kEAEE,SAAA,CACA,sBAAA,CAAA,cAAA,CAEF,iBACE,SAAA,CACA,qDAAA,CAAA,6CAAA,CAAA,qCAAA,CAAA,uDAAA,CAEF,mBACE,4BAAA,CAAA,oBAAA,CAEF,oBACE,4BAAA,CAAA,oBAAA,CAEF,gEAEE,SAAA,CACA,sBAAA,CAAA,cAAA,CAEF,iBACE,kCAAA,CACA,0BAAA,CACA,6CAAA,CAAA,qCAAA,CAAA,6BAAA,CAAA,gDAAA,CAEF,qBACE,qDAAA,CAAA,6CAAA,CAEF,sBACE,oDAAA,CAAA,4CAAA,CAEF,mBACE,qDAAA,CAAA,6CAAA,CAEF,qBACE,oDAAA,CAAA,4CAAA,CAEF,gEAEE,sBAAA,CAAA,cAAA","sourcesContent":["@use \"./typography\" as fonts;\r\n@use \"../abstracts/variables\" as var;\r\n@use \"../components/media\";\r\n\r\n* {\r\n  margin: 0;\r\n  padding: 0;\r\n  box-sizing: border-box;\r\n}\r\n\r\n*::before {\r\n  @extend *;\r\n}\r\n\r\n*::after {\r\n  @extend *;\r\n}\r\n\r\nhtml {\r\n  scroll-behavior: smooth;\r\n  scroll-padding-top: var(--scroll-padding, 50px);\r\n}\r\n\r\nbody {\r\n  font-family: map-get(fonts.$font-stack, main-font);\r\n  background-color: var.$body-color;\r\n  line-height: 1.6;\r\n  user-select: none;\r\n}\r\n\r\n.no-scroll {\r\n  overflow: hidden;\r\n}\r\n\r\n.header-bg {\r\n  background: radial-gradient(\r\n    250.88% 493.35% at 0% 0%,\r\n    #17202a 0%,\r\n    #1e6b9e 65.62%,\r\n    #2b85c0 100%\r\n  );\r\n  box-shadow: 0px 20px 40px rgba(0, 0, 0, 0.2);\r\n}\r\n\r\n.container {\r\n  overflow: hidden;\r\n  max-width: 1440px;\r\n  margin: 0 auto;\r\n  padding: 0 2rem;\r\n}\r\n\r\na {\r\n  text-decoration: none;\r\n}\r\n\r\nsection {\r\n  width: 100%;\r\n}\r\n\r\n.section-title {\r\n  position: relative;\r\n  margin-bottom: clamp(1.25rem, 8vw, 3.5rem);\r\n  font-size: clamp(1.563rem, 7vw, 3.5rem);\r\n  font-weight: map-get(fonts.$font-weight, medium);\r\n  color: var.$text-color-dark;\r\n\r\n  &::after {\r\n    content: \"\";\r\n    position: absolute;\r\n    bottom: 0;\r\n    left: 0;\r\n    width: 100%;\r\n    border-bottom: 5px solid var.$primary-color;\r\n    transform: scale(0, 1);\r\n    transform-origin: left;\r\n    transition: transform 1.8s ease-out;\r\n  }\r\n\r\n  &[data-scroll=\"in\"]::after {\r\n    transform: scale(1, 1);\r\n  }\r\n}\r\n\r\n::-webkit-scrollbar {\r\n  width: 0.5em;\r\n}\r\n\r\n::-webkit-scrollbar-track {\r\n  background-color: transparent;\r\n  border-radius: 100vw;\r\n}\r\n\r\n::-webkit-scrollbar-thumb {\r\n  background-color: var.$text-color-dark;\r\n  border-radius: 100vw;\r\n}\r\n\r\n@include media.large-phones {\r\n  .section-title::after {\r\n    border-bottom-width: 2px;\r\n  }\r\n}\r\n","// colors\r\n$primary-color: #1e6b9e;\r\n$secondary-color: #f0f0c9;\r\n$accent-color: #85c1e9;\r\n$body-color: #f8f9f9;\r\n$text-color-dark: #17202a;\r\n$text-color-light: #e5e5e5;\r\n\r\n// breakpoints\r\n$ultra-large-screen: 1921px;\r\n$extra-large-screen: 1440px;\r\n$large-screen: 1280px;\r\n$medium-screen: 768px;\r\n$small-screen: 600px;\r\n$extra-small-screen: 480px;\r\n$ultra-small-screen: 320px;\r\n","@use \"../abstracts/variables\" as var;\r\n\r\n@mixin desktops {\r\n  @media screen and (min-width: var.$ultra-large-screen) {\r\n    @content;\r\n  }\r\n}\r\n\r\n@mixin large-laptops {\r\n  @media screen and (max-width: var.$extra-large-screen) {\r\n    @content;\r\n  }\r\n}\r\n\r\n@mixin laptops {\r\n  @media screen and (max-width: var.$large-screen) {\r\n    @content;\r\n  }\r\n}\r\n\r\n@mixin tablets {\r\n  @media screen and (max-width: var.$medium-screen) {\r\n    @content;\r\n  }\r\n}\r\n\r\n@mixin large-phones {\r\n  @media screen and (max-width: var.$small-screen) {\r\n    @content;\r\n  }\r\n}\r\n\r\n@mixin small-phones {\r\n  @media screen and (max-width: var.$extra-small-screen) {\r\n    @content;\r\n  }\r\n}\r\n\r\n@mixin extra-small-phones {\r\n  @media screen and (max-width: var.$ultra-small-screen) {\r\n    @content;\r\n  }\r\n}\r\n","@use '../abstracts/mixins' as mixins;\r\n@use '../abstracts/variables' as var;\r\n@use '../base/typography' as font;\r\n@use '../components/media';\r\n\r\n#header {\r\n  position: fixed;\r\n  top: 0;\r\n  left: 0;\r\n  z-index: 999;\r\n  width: 100%;\r\n  padding: 0.8rem 0;\r\n  transition: all 0.5s ease-in;\r\n}\r\n\r\n.flex {\r\n  @include mixins.flex(space-between, center);\r\n  height: 100%;\r\n}\r\n\r\n#logo {\r\n  font-family: map-get(font.$font-stack, logo-font);\r\n  font-style: italic;\r\n  font-weight: map-get(font.$font-weight, regular);\r\n  font-size: 2.75rem;\r\n  color: var.$body-color;\r\n\r\n  & span {\r\n    display: inline-flex;\r\n  }\r\n\r\n  & span:nth-child(1) {\r\n    margin-right: -10px;\r\n    transform: matrix(-1, 0, 0, 1, 0, 0);\r\n    transition: all 0.5s ease;\r\n  }\r\n\r\n  & span:nth-child(even) {\r\n    overflow: hidden;\r\n    font-style: normal;\r\n    animation: logo 1s ease;\r\n    letter-spacing: -1em;\r\n    transition: all 0.5s ease 0.5s;\r\n  }\r\n\r\n  &:hover span:nth-child(1) {\r\n    margin-right: 0;\r\n    transform: matrix(1, 0, 0, 1, 0, 0);\r\n  }\r\n\r\n  &:hover span:nth-child(even) {\r\n    letter-spacing: -0.03em;\r\n  }\r\n}\r\n\r\n.nav-links {\r\n  position: relative;\r\n  display: flex;\r\n  list-style-type: none;\r\n\r\n  & li:not(:last-child) {\r\n    padding-right: 2rem;\r\n  }\r\n}\r\n\r\n.nav-link:not(.btn-outline-primary) {\r\n  position: relative;\r\n  padding-bottom: 0.5rem;\r\n  font-size: 1.25rem;\r\n  font-weight: map-get(font.$font-weight, medium);\r\n  color: var.$body-color;\r\n\r\n  &::after {\r\n    content: '';\r\n    position: absolute;\r\n    bottom: 0;\r\n    left: 0;\r\n    width: 100%;\r\n    border-bottom: 2px solid var.$body-color;\r\n    transform: scale(0, 1);\r\n    transform-origin: right;\r\n    transition: transform 0.3s ease-out;\r\n  }\r\n\r\n  &:hover::after {\r\n    transform: scale(1, 1);\r\n    transform-origin: left;\r\n  }\r\n\r\n  &.nav-active::after {\r\n    transform: scale(1, 1);\r\n    transform-origin: left;\r\n  }\r\n}\r\n\r\n@include media.tablets {\r\n  .nav-links {\r\n    position: fixed;\r\n    top: 0;\r\n    left: 0;\r\n    justify-content: space-around;\r\n    align-items: center;\r\n    flex-direction: column;\r\n    width: 100%;\r\n    height: 100vh;\r\n    padding: 8rem 0;\r\n    background: radial-gradient(\r\n      250.88% 493.35% at 0% 0%,\r\n      #17202a 0%,\r\n      #1e6b9e 65.62%,\r\n      #2b85c0 100%\r\n    );\r\n    clip-path: circle(100px at 100% -20%);\r\n    transition: all 1s ease-in-out;\r\n    pointer-events: none;\r\n\r\n    & li {\r\n      opacity: 0;\r\n      width: 100%;\r\n      text-align: center;\r\n      transform: translateX(100%);\r\n      transition: transform 0.5s ease-in-out 1s;\r\n\r\n      &:nth-of-type(1) {\r\n        transition-delay: 0.7s;\r\n      }\r\n      &:nth-of-type(2) {\r\n        transition-delay: 0.8s;\r\n      }\r\n      &:nth-of-type(3) {\r\n        transition-delay: 0.9s;\r\n      }\r\n      &:nth-of-type(4) {\r\n        transition-delay: 1s;\r\n      }\r\n\r\n      &.move {\r\n        opacity: 1;\r\n        transform: translateX(0);\r\n      }\r\n    }\r\n\r\n    & li:not(:last-child) {\r\n      padding-right: 0;\r\n    }\r\n\r\n    & li:nth-child(3) {\r\n      margin-bottom: 1rem;\r\n    }\r\n\r\n    &.open {\r\n      clip-path: circle(100% at center);\r\n      pointer-events: all;\r\n    }\r\n  }\r\n\r\n  .nav-link:not(.btn-outline-primary) {\r\n    padding-bottom: 0;\r\n    font-size: 1.5rem;\r\n  }\r\n}\r\n\r\n@include media.large-phones {\r\n  #logo {\r\n    font-size: 2.25rem;\r\n  }\r\n}\r\n\r\n@media (hover: none) {\r\n  .nav-link:not(.btn-outline-primary)::after {\r\n    border-bottom-width: 0;\r\n  }\r\n\r\n  #logo span:nth-child(1) {\r\n    transform: matrix(-1, 0, 0, 1, 0, 0);\r\n  }\r\n  #logo span:nth-child(even) {\r\n    letter-spacing: -1em;\r\n  }\r\n}\r\n","@mixin flex($justify-content, $align-items) {\r\n  display: flex;\r\n  justify-content: $justify-content;\r\n  align-items: $align-items;\r\n}\r\n","@use \"../abstracts/variables\" as var;\r\n@use \"../base/typography\" as font;\r\n@use \"../components/media\";\r\n\r\n#index {\r\n  position: relative;\r\n  padding-top: var(--scroll-padding, 50px);\r\n  min-height: 100vh;\r\n  background: radial-gradient(\r\n    250.88% 493.35% at 0% 0%,\r\n    #17202a 0%,\r\n    #1e6b9e 65.62%,\r\n    #2b85c0 100%\r\n  );\r\n\r\n  & h4 {\r\n    font-size: clamp(0.8rem, 3.5vw, 1.85rem);\r\n    font-weight: map-get(font.$font-weight, light);\r\n    color: var.$text-color-light;\r\n    letter-spacing: -0.07em;\r\n  }\r\n\r\n  & h1 {\r\n    margin-bottom: 0.5rem;\r\n    font-size: clamp(2rem, 8vw, 4.5rem);\r\n    font-weight: map-get(font.$font-weight, semi-bold);\r\n    color: var.$secondary-color;\r\n    line-height: clamp(34px, 8vw, 84px);\r\n    letter-spacing: -0.07em;\r\n\r\n    & span {\r\n      display: block;\r\n    }\r\n  }\r\n\r\n  & p {\r\n    margin-bottom: 2.2rem;\r\n    font-size: clamp(1.125rem, 4vw, 2rem);\r\n    font-weight: map-get(font.$font-weight, regular);\r\n    color: var.$text-color-light;\r\n    line-height: clamp(22px, 4vw, 42px);\r\n\r\n    & span {\r\n      display: block;\r\n    }\r\n  }\r\n\r\n  & .mail-icon {\r\n    margin-right: 0.5rem;\r\n    font-size: 1.25rem;\r\n    color: var.$text-color-dark;\r\n  }\r\n\r\n  & svg {\r\n    position: absolute;\r\n    right: 0;\r\n    bottom: 0;\r\n    width: 630px;\r\n    max-width: 100%;\r\n    height: auto;\r\n    object-fit: cover;\r\n  }\r\n}\r\n\r\n#context {\r\n  animation: context 1s linear infinite both;\r\n}\r\n\r\n#man {\r\n  animation: man 3s linear infinite;\r\n}\r\n\r\n@keyframes man {\r\n  0%,\r\n  100% {\r\n    opacity: 1;\r\n  }\r\n  41.99% {\r\n    opacity: 1;\r\n  }\r\n  42% {\r\n    opacity: 0;\r\n  }\r\n  43% {\r\n    opacity: 0;\r\n  }\r\n  43.01% {\r\n    opacity: 1;\r\n  }\r\n  45.99% {\r\n    opacity: 1;\r\n  }\r\n  46% {\r\n    opacity: 0;\r\n  }\r\n  46.9% {\r\n    opacity: 0;\r\n  }\r\n  46.91% {\r\n    opacity: 1;\r\n  }\r\n  51.99% {\r\n    opacity: 1;\r\n  }\r\n  52% {\r\n    opacity: 0;\r\n  }\r\n  52.8% {\r\n    opacity: 0;\r\n  }\r\n  52.81% {\r\n    opacity: 1;\r\n  }\r\n}\r\n\r\n@keyframes context {\r\n  0% {\r\n    transform: translate(0);\r\n  }\r\n  20% {\r\n    transform: translate(-2px, 2px);\r\n  }\r\n  40% {\r\n    transform: translate(-2px, -2px);\r\n  }\r\n  60% {\r\n    transform: translate(2px, 2px);\r\n  }\r\n  80% {\r\n    transform: translate(2px, -2px);\r\n  }\r\n  100% {\r\n    transform: translate(0);\r\n  }\r\n}\r\n\r\n@include media.desktops {\r\n  #index {\r\n    padding-top: 20rem;\r\n\r\n    & svg {\r\n      width: 1300px;\r\n    }\r\n  }\r\n}\r\n\r\n@include media.large-laptops {\r\n  #index {\r\n    & svg {\r\n      width: 600px;\r\n    }\r\n  }\r\n}\r\n\r\n@include media.laptops {\r\n  #index {\r\n    & .mail-icon {\r\n      font-size: 1.125rem;\r\n    }\r\n  }\r\n}\r\n\r\n@include media.tablets {\r\n  #index {\r\n    & p {\r\n      margin-bottom: 1.5rem;\r\n    }\r\n  }\r\n}\r\n\r\n@include media.large-phones {\r\n  #index {\r\n    padding-top: 6.5rem;\r\n\r\n    & svg {\r\n      opacity: 0.7;\r\n    }\r\n  }\r\n}\r\n\r\n@include media.small-phones {\r\n  #index {\r\n    & svg {\r\n      opacity: 1;\r\n    }\r\n  }\r\n}\r\n\r\n@include media.extra-small-phones {\r\n  #index {\r\n    & h1 {\r\n      font-size: 1.75rem;\r\n    }\r\n\r\n    & svg {\r\n      width: 300px;\r\n      opacity: 0.3;\r\n    }\r\n\r\n    & .mail-icon {\r\n      font-size: 0.875rem;\r\n    }\r\n  }\r\n}\r\n","@use \"../abstracts/variables\" as var;\r\n@use \"../abstracts/mixins\";\r\n@use \"../base/typography\" as font;\r\n@use \"../components/media\";\r\n\r\n#projects {\r\n  margin: 3rem 0;\r\n  & .project {\r\n    margin-bottom: 1.5rem;\r\n    & img {\r\n      width: 100%;\r\n      max-width: 100%;\r\n      height: auto;\r\n      object-fit: cover;\r\n      margin-bottom: 1.75rem;\r\n      background: radial-gradient(\r\n        136.17% 288.39% at -14.09% -13.71%,\r\n        #17202a 0%,\r\n        #1e6b9e 71.35%,\r\n        #2b85c0 100%\r\n      );\r\n      border-radius: 5px;\r\n    }\r\n\r\n    & .project-title {\r\n      font-size: clamp(1.125rem, 6vw, 3rem);\r\n      font-weight: map-get(font.$font-weight, regular);\r\n      white-space: nowrap;\r\n      color: var.$text-color-dark;\r\n    }\r\n\r\n    & .project-desc {\r\n      margin-bottom: clamp(0.5rem, 4vw, 1.5rem);\r\n      font-size: clamp(0.938rem, 4vw, 1.5rem);\r\n      font-weight: map-get(font.$font-weight, light);\r\n      line-height: 32px;\r\n      color: var.$text-color-dark;\r\n\r\n      & span {\r\n        display: block;\r\n      }\r\n    }\r\n\r\n    & .contributions {\r\n      margin-bottom: 2rem;\r\n      white-space: nowrap;\r\n      & span {\r\n        padding: 0.5em 1em;\r\n        font-size: clamp(0.64rem, 2vw, 0.9rem);\r\n        font-weight: map-get(font.$font-weight, regular);\r\n        text-transform: uppercase;\r\n        white-space: nowrap;\r\n        background-color: var.$secondary-color;\r\n        color: var.$text-color-dark;\r\n        border-radius: 20px;\r\n      }\r\n\r\n      & span:nth-child(2) {\r\n        margin: 0 0.3rem;\r\n      }\r\n    }\r\n\r\n    & .project-links {\r\n      display: inline-flex;\r\n      justify-content: space-between;\r\n      align-items: center;\r\n      flex-wrap: wrap;\r\n\r\n      & a:first-child {\r\n        margin-right: 4rem;\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n@include media.tablets {\r\n  #projects .project .project-desc span {\r\n    display: inline;\r\n  }\r\n}\r\n\r\n@include media.large-phones {\r\n  #projects .project {\r\n    & .project-desc {\r\n      line-height: normal;\r\n    }\r\n\r\n    & .project-links {\r\n      @include mixins.flex(center, center);\r\n      flex-direction: column;\r\n\r\n      & a:first-child {\r\n        margin-right: 0;\r\n        margin-bottom: 1.2rem;\r\n      }\r\n\r\n      & a i {\r\n        font-size: 1rem;\r\n      }\r\n    }\r\n  }\r\n}\r\n","@use \"../abstracts/mixins\";\r\n@use \"../abstracts/variables\" as var;\r\n@use \"../base/typography\" as fonts;\r\n@use \"../components/media\";\r\n\r\n#about {\r\n  margin-bottom: 5rem;\r\n  & .profile {\r\n    @include mixins.flex(center, center);\r\n    margin-bottom: clamp(1.5rem, 8vw, 8rem);\r\n    & img {\r\n      width: 400px;\r\n      max-width: 100%;\r\n      height: auto;\r\n      object-fit: cover;\r\n      margin-right: 4rem;\r\n    }\r\n\r\n    & .details {\r\n      & p {\r\n        margin-bottom: 1.5rem;\r\n        font-size: 2rem;\r\n        font-weight: map-get(fonts.$font-weight, light);\r\n        color: var.$text-color-dark;\r\n        line-height: 42px;\r\n\r\n        & span {\r\n          display: block;\r\n        }\r\n      }\r\n\r\n      & a {\r\n        font-weight: map-get(fonts.$font-weight, medium);\r\n      }\r\n    }\r\n  }\r\n\r\n  & .skills {\r\n    margin-bottom: clamp(1.5rem, 8vw, 5rem);\r\n    & h2 {\r\n      margin-bottom: 1rem;\r\n      font-size: clamp(1.5rem, 6vw, 3rem);\r\n      font-weight: map-get(fonts.$font-weight, medium);\r\n      white-space: nowrap;\r\n      color: var.$text-color-dark;\r\n    }\r\n\r\n    & p {\r\n      font-size: clamp(1rem, 5vw, 2rem);\r\n      font-weight: map-get(fonts.$font-weight, light);\r\n      color: var.$text-color-dark;\r\n      line-height: 42px;\r\n\r\n      & span {\r\n        display: block;\r\n      }\r\n    }\r\n  }\r\n\r\n  & .awards {\r\n    & h2 {\r\n      margin-bottom: 1rem;\r\n      font-size: clamp(1.25rem, 6vw, 3rem);\r\n      font-weight: map-get(fonts.$font-weight, medium);\r\n      color: var.$text-color-dark;\r\n    }\r\n\r\n    & .awards-link {\r\n      list-style-type: none;\r\n\r\n      & li {\r\n        & a {\r\n          font-size: clamp(1rem, 5vw, 2rem);\r\n          font-weight: map-get(fonts.$font-weight, light);\r\n          color: var.$text-color-dark;\r\n          transition: color 0.3s ease-out;\r\n\r\n          &:hover {\r\n            color: var.$primary-color;\r\n          }\r\n        }\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n@include media.laptops {\r\n  #about .profile {\r\n    flex-wrap: wrap;\r\n    & img {\r\n      width: 350px;\r\n      margin-bottom: 1.5rem;\r\n    }\r\n\r\n    & .details p {\r\n      font-size: 1.75rem;\r\n    }\r\n  }\r\n}\r\n\r\n@include media.tablets {\r\n  #about .profile {\r\n    & img {\r\n      margin-right: 0;\r\n    }\r\n\r\n    & .details p {\r\n      font-size: 1.563rem;\r\n    }\r\n  }\r\n\r\n  #about .skills p {\r\n    line-height: normal;\r\n\r\n    & span {\r\n      display: inline;\r\n    }\r\n  }\r\n}\r\n\r\n@include media.large-phones {\r\n  #about .profile {\r\n    & img {\r\n      width: 280px;\r\n    }\r\n\r\n    & .details p {\r\n      font-size: 1.125rem;\r\n      line-height: normal;\r\n\r\n      & span {\r\n        display: inline;\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n@media (hover: none) {\r\n  #about .awards .awards-link li a {\r\n    color: var.$text-color-dark;\r\n  }\r\n}\r\n","@use \"../abstracts/variables\" as var;\r\n@use \"../base/typography\" as fonts;\r\n@use \"../components/media\";\r\n\r\n#contact {\r\n  padding: 4rem 0;\r\n  background: radial-gradient(\r\n    250.88% 493.35% at 0% 0%,\r\n    #17202a 0%,\r\n    #1e6b9e 65.62%,\r\n    #2b85c0 100%\r\n  );\r\n\r\n  & h4 {\r\n    font-size: clamp(1.25rem, 4vw, 3rem);\r\n    font-weight: map-get(fonts.$font-weight, light);\r\n    text-align: center;\r\n    color: var.$secondary-color;\r\n  }\r\n\r\n  & h1 {\r\n    position: relative;\r\n    margin-bottom: 1rem;\r\n    padding-bottom: clamp(1rem, 5vw, 3.5rem);\r\n    font-size: clamp(1.4rem, 6vw, 6rem);\r\n    font-weight: map-get(fonts.$font-weight, medium);\r\n    text-align: center;\r\n    word-wrap: break-word;\r\n    letter-spacing: -0.075em;\r\n\r\n    & a {\r\n      color: var.$body-color;\r\n      transition: color 0.3s ease-out;\r\n\r\n      &:hover {\r\n        color: var.$accent-color;\r\n      }\r\n    }\r\n\r\n    &::after {\r\n      content: \"\";\r\n      position: absolute;\r\n      bottom: 0;\r\n      left: 0;\r\n      width: 100%;\r\n      border-bottom: 5px solid var.$accent-color;\r\n      transform: scale(0, 1);\r\n      transform-origin: left;\r\n      transition: transform 1.5s ease-out;\r\n    }\r\n    &[data-scroll=\"in\"]::after {\r\n      transform: scale(1, 1);\r\n    }\r\n  }\r\n}\r\n\r\n@include media.large-phones {\r\n  #contact h1::after {\r\n    border-bottom-width: 2px;\r\n  }\r\n}\r\n\r\n@media (hover: none) {\r\n  #contact h1 a {\r\n    color: var.$body-color;\r\n  }\r\n}\r\n","@use \"../abstracts/mixins\";\r\n@use \"../abstracts/variables\" as var;\r\n@use \"../base/typography\" as fonts;\r\n@use \"../components/media\";\r\n\r\n#footer {\r\n  width: 100%;\r\n  & .flex-footer {\r\n    @include mixins.flex(space-between, center);\r\n    font-family: map-get(fonts.$font-stack, logo-font);\r\n\r\n    & .copyright {\r\n      font-size: clamp(1rem, 4vw, 1.5rem);\r\n      font-weight: map-get(fonts.$font-weight, light);\r\n      letter-spacing: -1.2px;\r\n      color: var.$body-color;\r\n\r\n      & span {\r\n        font-style: italic;\r\n      }\r\n    }\r\n\r\n    & .social-links {\r\n      display: flex;\r\n      font-size: clamp(1rem, 4vw, 1.25rem);\r\n      font-weight: map-get(fonts.$font-weight, light);\r\n      letter-spacing: -1.2px;\r\n      color: var.$body-color;\r\n\r\n      & li {\r\n        transition: color 0.3s ease-out;\r\n\r\n        & a {\r\n          color: var.$body-color;\r\n          transition: color 0.3s ease-out;\r\n\r\n          &:hover {\r\n            color: var.$accent-color;\r\n          }\r\n        }\r\n\r\n        &:hover {\r\n          color: var.$accent-color;\r\n        }\r\n      }\r\n\r\n      & li:not(:last-child) {\r\n        padding-right: 2rem;\r\n        margin-right: 0.5rem;\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n@include media.tablets {\r\n  #footer .flex-footer {\r\n    flex-direction: column-reverse;\r\n\r\n    & .social-links {\r\n      margin-bottom: 1rem;\r\n    }\r\n  }\r\n}\r\n\r\n@include media.large-phones {\r\n  #footer {\r\n    & .flex-footer {\r\n      justify-content: flex-start;\r\n      align-items: flex-start;\r\n\r\n      & .social-links {\r\n        display: block;\r\n        margin-left: 1.5rem;\r\n\r\n        & li {\r\n          margin-bottom: 1rem;\r\n        }\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n@media (hover: none) {\r\n  #footer .flex-footer .social-links li {\r\n    color: var.$body-color;\r\n\r\n    & a {\r\n      color: var.$body-color;\r\n    }\r\n  }\r\n}\r\n","@use \"../base/typography\" as fonts;\r\n@use \"../abstracts/variables\" as var;\r\n@use \"./media\";\r\n\r\n.btn-outline-primary {\r\n  position: relative;\r\n  overflow: hidden;\r\n  z-index: 1;\r\n  padding: 0.65em 1.25em;\r\n  font-size: 1.25rem;\r\n  font-weight: map-get(fonts.$font-weight, medium);\r\n  white-space: nowrap;\r\n  color: var.$accent-color;\r\n  border: 2px solid var.$accent-color;\r\n  border-radius: 5px;\r\n  box-shadow: inset 0 0 0 0 var.$secondary-color;\r\n  transition: all 0.5s ease-out;\r\n\r\n  &:hover {\r\n    color: var.$text-color-dark;\r\n    box-shadow: inset 0 -100px 0 0 var.$secondary-color;\r\n    border-color: var.$secondary-color;\r\n  }\r\n}\r\n\r\n.btn-primary {\r\n  position: relative;\r\n  overflow: hidden;\r\n  z-index: 1;\r\n  display: inline-flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  padding: 0.65em 1.25em;\r\n  font-size: 1.25rem;\r\n  font-weight: map-get(fonts.$font-weight, medium);\r\n  white-space: nowrap;\r\n  background-color: var.$secondary-color;\r\n  color: var.$text-color-dark;\r\n  border-radius: 5px;\r\n  transition: transform 0.3s ease-out;\r\n\r\n  &:hover {\r\n    transform: translateY(-7px);\r\n  }\r\n}\r\n\r\n.btn-link {\r\n  position: relative;\r\n  display: inline-flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  font-size: 1.25rem;\r\n  font-weight: map-get(fonts.$font-weight, regular);\r\n  white-space: nowrap;\r\n  color: var.$text-color-dark;\r\n\r\n  & span {\r\n    margin-right: 0.5rem;\r\n  }\r\n\r\n  &::after {\r\n    content: \"\";\r\n    position: absolute;\r\n    bottom: 0;\r\n    left: 0;\r\n    width: 100%;\r\n    border-bottom: 2px solid var.$text-color-dark;\r\n    transform: scale(0, 1);\r\n    transform-origin: right;\r\n    transition: transform 0.3s ease-out;\r\n  }\r\n\r\n  &:hover::after {\r\n    transform: scale(1, 1);\r\n    transform-origin: left;\r\n  }\r\n\r\n  & i {\r\n    font-size: 1.25rem;\r\n    transition: transform 0.3s ease;\r\n  }\r\n\r\n  &:hover i {\r\n    transform: translateX(5px);\r\n  }\r\n}\r\n\r\n@include media.laptops {\r\n  .btn-primary,\r\n  .btn-link {\r\n    font-size: 1.125rem;\r\n  }\r\n}\r\n\r\n@include media.tablets {\r\n  .btn-primary,\r\n  .btn-link {\r\n    font-size: 1rem;\r\n  }\r\n}\r\n\r\n@include media.extra-small-phones {\r\n  .btn-primary,\r\n  .btn-link {\r\n    font-size: 0.875rem;\r\n  }\r\n}\r\n\r\n@media (hover: none) {\r\n  .btn-link::after {\r\n    border-bottom-width: 0;\r\n  }\r\n\r\n  .btn-outline-primary {\r\n    color: var.$accent-color;\r\n    box-shadow: inset 0 0 0 0 var.$secondary-color;\r\n    border-color: var.$accent-color;\r\n  }\r\n}\r\n","/*!\r\n * Hamburgers\r\n * @description Tasty CSS-animated hamburgers\r\n * @author Jonathan Suh @jonsuh\r\n * @site https://jonsuh.com/hamburgers\r\n * @link https://github.com/jonsuh/hamburgers\r\n */\r\n\r\n@use \"../abstracts/variables\" as var;\r\n@use \"../components/media\";\r\n\r\n.hamburger {\r\n  overflow: visible;\r\n  display: none;\r\n  margin: 0;\r\n  //padding: 15px 15px;\r\n  font: inherit;\r\n  background-color: transparent;\r\n  color: inherit;\r\n  text-transform: none;\r\n  border: 0;\r\n  cursor: pointer;\r\n  transition-property: opacity, filter;\r\n  transition-duration: 0.15s;\r\n  transition-timing-function: linear;\r\n}\r\n\r\n.hamburger:hover {\r\n  opacity: 0.7;\r\n}\r\n.hamburger.is-active:hover {\r\n  opacity: 0.7;\r\n}\r\n\r\n.hamburger.is-active .hamburger-inner,\r\n.hamburger.is-active .hamburger-inner::before,\r\n.hamburger.is-active .hamburger-inner::after {\r\n  background-color: var.$body-color;\r\n}\r\n\r\n.hamburger-box {\r\n  position: relative;\r\n  width: 35px;\r\n  height: 24px;\r\n}\r\n\r\n.hamburger-inner {\r\n  display: block;\r\n  top: 50%;\r\n  margin-top: -2px;\r\n}\r\n.hamburger-inner,\r\n.hamburger-inner::before,\r\n.hamburger-inner::after {\r\n  position: absolute;\r\n  width: 35px;\r\n  height: 4px;\r\n  background-color: var.$body-color;\r\n  border-radius: 4px;\r\n  transition: transform 0.15s ease;\r\n}\r\n.hamburger-inner::before,\r\n.hamburger-inner::after {\r\n  content: \"\";\r\n  display: block;\r\n}\r\n.hamburger-inner::before {\r\n  top: -10px;\r\n}\r\n.hamburger-inner::after {\r\n  bottom: -10px;\r\n}\r\n\r\n// Collapse\r\n.hamburger--collapse .hamburger-inner {\r\n  top: auto;\r\n  bottom: 0;\r\n  transition-duration: 0.13s;\r\n  transition-delay: 0.13s;\r\n  transition-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\r\n}\r\n.hamburger--collapse .hamburger-inner::after {\r\n  top: -20px;\r\n  transition: top 0.2s 0.2s cubic-bezier(0.33333, 0.66667, 0.66667, 1),\r\n    opacity 0.1s linear;\r\n}\r\n.hamburger--collapse .hamburger-inner::before {\r\n  transition: top 0.12s 0.2s cubic-bezier(0.33333, 0.66667, 0.66667, 1),\r\n    transform 0.13s cubic-bezier(0.55, 0.055, 0.675, 0.19);\r\n}\r\n\r\n.hamburger--collapse.is-active .hamburger-inner {\r\n  transform: translate3d(0, -10px, 0) rotate(-45deg);\r\n  transition-delay: 0.22s;\r\n  transition-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\r\n}\r\n.hamburger--collapse.is-active .hamburger-inner::after {\r\n  top: 0;\r\n  opacity: 0;\r\n  transition: top 0.2s cubic-bezier(0.33333, 0, 0.66667, 0.33333),\r\n    opacity 0.1s 0.22s linear;\r\n}\r\n.hamburger--collapse.is-active .hamburger-inner::before {\r\n  top: 0;\r\n  transform: rotate(-90deg);\r\n  transition: top 0.1s 0.16s cubic-bezier(0.33333, 0, 0.66667, 0.33333),\r\n    transform 0.13s 0.25s cubic-bezier(0.215, 0.61, 0.355, 1);\r\n}\r\n\r\n@include media.tablets {\r\n  .hamburger {\r\n    display: inline-block;\r\n  }\r\n}\r\n\r\n@include media.large-phones {\r\n  .hamburger-inner,\r\n  .hamburger-inner::before,\r\n  .hamburger-inner::after {\r\n    width: 30px;\r\n    height: 3px;\r\n  }\r\n}\r\n","[data-sal] {\r\n  transition-delay: 0s;\r\n  transition-delay: var(--sal-delay, 0s);\r\n  transition-duration: 0.2s;\r\n  transition-duration: var(--sal-duration, 0.2s);\r\n  transition-timing-function: ease;\r\n  transition-timing-function: var(--sal-easing, ease);\r\n}\r\n[data-sal][data-sal-duration=\"200\"] {\r\n  transition-duration: 0.2s;\r\n}\r\n[data-sal][data-sal-duration=\"250\"] {\r\n  transition-duration: 0.25s;\r\n}\r\n[data-sal][data-sal-duration=\"300\"] {\r\n  transition-duration: 0.3s;\r\n}\r\n[data-sal][data-sal-duration=\"350\"] {\r\n  transition-duration: 0.35s;\r\n}\r\n[data-sal][data-sal-duration=\"400\"] {\r\n  transition-duration: 0.4s;\r\n}\r\n[data-sal][data-sal-duration=\"450\"] {\r\n  transition-duration: 0.45s;\r\n}\r\n[data-sal][data-sal-duration=\"500\"] {\r\n  transition-duration: 0.5s;\r\n}\r\n[data-sal][data-sal-duration=\"550\"] {\r\n  transition-duration: 0.55s;\r\n}\r\n[data-sal][data-sal-duration=\"600\"] {\r\n  transition-duration: 0.6s;\r\n}\r\n[data-sal][data-sal-duration=\"650\"] {\r\n  transition-duration: 0.65s;\r\n}\r\n[data-sal][data-sal-duration=\"700\"] {\r\n  transition-duration: 0.7s;\r\n}\r\n[data-sal][data-sal-duration=\"750\"] {\r\n  transition-duration: 0.75s;\r\n}\r\n[data-sal][data-sal-duration=\"800\"] {\r\n  transition-duration: 0.8s;\r\n}\r\n[data-sal][data-sal-duration=\"850\"] {\r\n  transition-duration: 0.85s;\r\n}\r\n[data-sal][data-sal-duration=\"900\"] {\r\n  transition-duration: 0.9s;\r\n}\r\n[data-sal][data-sal-duration=\"950\"] {\r\n  transition-duration: 0.95s;\r\n}\r\n[data-sal][data-sal-duration=\"1000\"] {\r\n  transition-duration: 1s;\r\n}\r\n[data-sal][data-sal-duration=\"1050\"] {\r\n  transition-duration: 1.05s;\r\n}\r\n[data-sal][data-sal-duration=\"1100\"] {\r\n  transition-duration: 1.1s;\r\n}\r\n[data-sal][data-sal-duration=\"1150\"] {\r\n  transition-duration: 1.15s;\r\n}\r\n[data-sal][data-sal-duration=\"1200\"] {\r\n  transition-duration: 1.2s;\r\n}\r\n[data-sal][data-sal-duration=\"1250\"] {\r\n  transition-duration: 1.25s;\r\n}\r\n[data-sal][data-sal-duration=\"1300\"] {\r\n  transition-duration: 1.3s;\r\n}\r\n[data-sal][data-sal-duration=\"1350\"] {\r\n  transition-duration: 1.35s;\r\n}\r\n[data-sal][data-sal-duration=\"1400\"] {\r\n  transition-duration: 1.4s;\r\n}\r\n[data-sal][data-sal-duration=\"1450\"] {\r\n  transition-duration: 1.45s;\r\n}\r\n[data-sal][data-sal-duration=\"1500\"] {\r\n  transition-duration: 1.5s;\r\n}\r\n[data-sal][data-sal-duration=\"1550\"] {\r\n  transition-duration: 1.55s;\r\n}\r\n[data-sal][data-sal-duration=\"1600\"] {\r\n  transition-duration: 1.6s;\r\n}\r\n[data-sal][data-sal-duration=\"1650\"] {\r\n  transition-duration: 1.65s;\r\n}\r\n[data-sal][data-sal-duration=\"1700\"] {\r\n  transition-duration: 1.7s;\r\n}\r\n[data-sal][data-sal-duration=\"1750\"] {\r\n  transition-duration: 1.75s;\r\n}\r\n[data-sal][data-sal-duration=\"1800\"] {\r\n  transition-duration: 1.8s;\r\n}\r\n[data-sal][data-sal-duration=\"1850\"] {\r\n  transition-duration: 1.85s;\r\n}\r\n[data-sal][data-sal-duration=\"1900\"] {\r\n  transition-duration: 1.9s;\r\n}\r\n[data-sal][data-sal-duration=\"1950\"] {\r\n  transition-duration: 1.95s;\r\n}\r\n[data-sal][data-sal-duration=\"2000\"] {\r\n  transition-duration: 2s;\r\n}\r\n[data-sal][data-sal-delay=\"50\"] {\r\n  transition-delay: 0.05s;\r\n}\r\n[data-sal][data-sal-delay=\"100\"] {\r\n  transition-delay: 0.1s;\r\n}\r\n[data-sal][data-sal-delay=\"150\"] {\r\n  transition-delay: 0.15s;\r\n}\r\n[data-sal][data-sal-delay=\"200\"] {\r\n  transition-delay: 0.2s;\r\n}\r\n[data-sal][data-sal-delay=\"250\"] {\r\n  transition-delay: 0.25s;\r\n}\r\n[data-sal][data-sal-delay=\"300\"] {\r\n  transition-delay: 0.3s;\r\n}\r\n[data-sal][data-sal-delay=\"350\"] {\r\n  transition-delay: 0.35s;\r\n}\r\n[data-sal][data-sal-delay=\"400\"] {\r\n  transition-delay: 0.4s;\r\n}\r\n[data-sal][data-sal-delay=\"450\"] {\r\n  transition-delay: 0.45s;\r\n}\r\n[data-sal][data-sal-delay=\"500\"] {\r\n  transition-delay: 0.5s;\r\n}\r\n[data-sal][data-sal-delay=\"550\"] {\r\n  transition-delay: 0.55s;\r\n}\r\n[data-sal][data-sal-delay=\"600\"] {\r\n  transition-delay: 0.6s;\r\n}\r\n[data-sal][data-sal-delay=\"650\"] {\r\n  transition-delay: 0.65s;\r\n}\r\n[data-sal][data-sal-delay=\"700\"] {\r\n  transition-delay: 0.7s;\r\n}\r\n[data-sal][data-sal-delay=\"750\"] {\r\n  transition-delay: 0.75s;\r\n}\r\n[data-sal][data-sal-delay=\"800\"] {\r\n  transition-delay: 0.8s;\r\n}\r\n[data-sal][data-sal-delay=\"850\"] {\r\n  transition-delay: 0.85s;\r\n}\r\n[data-sal][data-sal-delay=\"900\"] {\r\n  transition-delay: 0.9s;\r\n}\r\n[data-sal][data-sal-delay=\"950\"] {\r\n  transition-delay: 0.95s;\r\n}\r\n[data-sal][data-sal-delay=\"1000\"] {\r\n  transition-delay: 1s;\r\n}\r\n[data-sal][data-sal-easing=\"linear\"] {\r\n  transition-timing-function: linear;\r\n}\r\n[data-sal][data-sal-easing=\"ease\"] {\r\n  transition-timing-function: ease;\r\n}\r\n[data-sal][data-sal-easing=\"ease-in\"] {\r\n  transition-timing-function: ease-in;\r\n}\r\n[data-sal][data-sal-easing=\"ease-out\"] {\r\n  transition-timing-function: ease-out;\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-out\"] {\r\n  transition-timing-function: ease-in-out;\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-cubic\"] {\r\n  transition-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\r\n}\r\n[data-sal][data-sal-easing=\"ease-out-cubic\"] {\r\n  transition-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-out-cubic\"] {\r\n  transition-timing-function: cubic-bezier(0.645, 0.045, 0.355, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-circ\"] {\r\n  transition-timing-function: cubic-bezier(0.6, 0.04, 0.98, 0.335);\r\n}\r\n[data-sal][data-sal-easing=\"ease-out-circ\"] {\r\n  transition-timing-function: cubic-bezier(0.075, 0.82, 0.165, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-out-circ\"] {\r\n  transition-timing-function: cubic-bezier(0.785, 0.135, 0.15, 0.86);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-expo\"] {\r\n  transition-timing-function: cubic-bezier(0.95, 0.05, 0.795, 0.035);\r\n}\r\n[data-sal][data-sal-easing=\"ease-out-expo\"] {\r\n  transition-timing-function: cubic-bezier(0.19, 1, 0.22, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-out-expo\"] {\r\n  transition-timing-function: cubic-bezier(1, 0, 0, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-quad\"] {\r\n  transition-timing-function: cubic-bezier(0.55, 0.085, 0.68, 0.53);\r\n}\r\n[data-sal][data-sal-easing=\"ease-out-quad\"] {\r\n  transition-timing-function: cubic-bezier(0.25, 0.46, 0.45, 0.94);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-out-quad\"] {\r\n  transition-timing-function: cubic-bezier(0.455, 0.03, 0.515, 0.955);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-quart\"] {\r\n  transition-timing-function: cubic-bezier(0.895, 0.03, 0.685, 0.22);\r\n}\r\n[data-sal][data-sal-easing=\"ease-out-quart\"] {\r\n  transition-timing-function: cubic-bezier(0.165, 0.84, 0.44, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-out-quart\"] {\r\n  transition-timing-function: cubic-bezier(0.77, 0, 0.175, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-quint\"] {\r\n  transition-timing-function: cubic-bezier(0.755, 0.05, 0.855, 0.06);\r\n}\r\n[data-sal][data-sal-easing=\"ease-out-quint\"] {\r\n  transition-timing-function: cubic-bezier(0.23, 1, 0.32, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-out-quint\"] {\r\n  transition-timing-function: cubic-bezier(0.86, 0, 0.07, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-sine\"] {\r\n  transition-timing-function: cubic-bezier(0.47, 0, 0.745, 0.715);\r\n}\r\n[data-sal][data-sal-easing=\"ease-out-sine\"] {\r\n  transition-timing-function: cubic-bezier(0.39, 0.575, 0.565, 1);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-out-sine\"] {\r\n  transition-timing-function: cubic-bezier(0.445, 0.05, 0.55, 0.95);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-back\"] {\r\n  transition-timing-function: cubic-bezier(0.6, -0.28, 0.735, 0.045);\r\n}\r\n[data-sal][data-sal-easing=\"ease-out-back\"] {\r\n  transition-timing-function: cubic-bezier(0.175, 0.885, 0.32, 1.275);\r\n}\r\n[data-sal][data-sal-easing=\"ease-in-out-back\"] {\r\n  transition-timing-function: cubic-bezier(0.68, -0.55, 0.265, 1.55);\r\n}\r\n[data-sal|=\"fade\"] {\r\n  opacity: 0;\r\n  transition-property: opacity;\r\n}\r\n[data-sal|=\"fade\"].sal-animate,\r\nbody.sal-disabled [data-sal|=\"fade\"] {\r\n  opacity: 1;\r\n}\r\n[data-sal|=\"slide\"] {\r\n  opacity: 0;\r\n  transition-property: opacity, transform;\r\n}\r\n[data-sal=\"slide-up\"] {\r\n  transform: translateY(20%);\r\n}\r\n[data-sal=\"slide-down\"] {\r\n  transform: translateY(-20%);\r\n}\r\n[data-sal=\"slide-left\"] {\r\n  transform: translateX(20%);\r\n}\r\n[data-sal=\"slide-right\"] {\r\n  transform: translateX(-20%);\r\n}\r\n[data-sal|=\"slide\"].sal-animate,\r\nbody.sal-disabled [data-sal|=\"slide\"] {\r\n  opacity: 1;\r\n  transform: none;\r\n}\r\n[data-sal|=\"zoom\"] {\r\n  opacity: 0;\r\n  transition-property: opacity, transform;\r\n}\r\n[data-sal=\"zoom-in\"] {\r\n  transform: scale(0.5);\r\n}\r\n[data-sal=\"zoom-out\"] {\r\n  transform: scale(1.1);\r\n}\r\n[data-sal|=\"zoom\"].sal-animate,\r\nbody.sal-disabled [data-sal|=\"zoom\"] {\r\n  opacity: 1;\r\n  transform: none;\r\n}\r\n[data-sal|=\"flip\"] {\r\n  -webkit-backface-visibility: hidden;\r\n  backface-visibility: hidden;\r\n  transition-property: transform;\r\n}\r\n[data-sal=\"flip-left\"] {\r\n  transform: perspective(2000px) rotateY(-91deg);\r\n}\r\n[data-sal=\"flip-right\"] {\r\n  transform: perspective(2000px) rotateY(91deg);\r\n}\r\n[data-sal=\"flip-up\"] {\r\n  transform: perspective(2000px) rotateX(-91deg);\r\n}\r\n[data-sal=\"flip-down\"] {\r\n  transform: perspective(2000px) rotateX(91deg);\r\n}\r\n[data-sal|=\"flip\"].sal-animate,\r\nbody.sal-disabled [data-sal|=\"flip\"] {\r\n  transform: none;\r\n}\r\n\r\n/*# sourceMappingURL=sal.css.map*/\r\n"],"sourceRoot":""}]);
// Exports
...
var favicon_namespaceObject = __webpack_require__.p + "favicon.ico";
;// CONCATENATED MODULE: ./src/assets/images/favicon.png
var assets_images_favicon_namespaceObject = __webpack_require__.p + "favicon.png";
;// CONCATENATED MODULE: ./src/assets/upload/Raven Barrogo - Resume.pdf
var Raven_Barrogo_Resume_namespaceObject = __webpack_require__.p + "Raven Barrogo - Resume.pdf";
;// CONCATENATED MODULE: ./src/components/layout/header/Header.js


var Header = function Header() {
  var template = "\n  <header id=\"header\" data-sal=\"slide-up\" data-sal-duration=\"800\" data-sal-easing=\"ease-out-back\">\n    <div class=\"container flex\">\n      <a href=\"#index\" id=\"logo\"><span>r</span><span>aven</span><span>b</span><span>arrogo</span></a>\n      <nav>\n        <ul class=\"nav-links\">\n          <li><a href=\"#projects\" class=\"nav-link\">Projects</a></li>\n          <li><a href=\"#about\" class=\"nav-link\">About</a></li>\n          <li><a href=\"#contact\" class=\"nav-link\">Contact</a></li>\n          <li><a href=\"".concat(Raven_Barrogo_Resume_namespaceObject, "\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"nav-link btn-outline-primary\">Resume</a></li>\n        </ul>\n      </nav>\n      <div class=\"hamburger hamburger--collapse\">\n        <div class=\"hamburger-box\">\n          <div class=\"hamburger-inner\"></div>\n        </div>\n      </div>\n    </div>\n  </header>");
  return template;
};

/* harmony default export */ var header_Header = (Header);
;// CONCATENATED MODULE: ./src/assets/images/inviclothing-mockup.png
var inviclothing_mockup_namespaceObject = __webpack_require__.p + "inviclothing-mockup.png";
;// CONCATENATED MODULE: ./src/assets/images/face-recognition-mockup.png
var face_recognition_mockup_namespaceObject = __webpack_require__.p + "face-recognition-mockup.png";
;// CONCATENATED MODULE: ./src/assets/images/display-picture.png
var display_picture_namespaceObject = __webpack_require__.p + "display-picture.png";
;// CONCATENATED MODULE: ./src/assets/images/JavaScript Certificate - Sololearn.png
var JavaScript_Certificate_Sololearn_namespaceObject = __webpack_require__.p + "JavaScript Certificate - Sololearn.png";
...
;// CONCATENATED MODULE: ./src/components/layout/content/Content.js
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/main.scss
var main = __webpack_require__(369);
...
var update = injectStylesIntoStyleTag_default()(main/* default */.Z, options);
       ...
       /* harmony default export */ var scss_main = (main/* default */.Z && main/* default.locals */.Z.locals ? main/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/sal.js/dist/sal.js
var sal = __webpack_require__(153);
var sal_default = /*#__PURE__*/__webpack_require__.n(sal);
...
var app = function app() {
  document.querySelector('#root').appendChild(src_app());
};

app(); // Declaring variables

var header = document.querySelector('#header');
var hamburger = document.querySelector('.hamburger');
var hamburgerOpen = true;
var nav = document.querySelector('.nav-links');
var navList = document.querySelectorAll('.nav-links li');
var navLinks = document.querySelectorAll('.nav-link');
var sections = document.querySelectorAll('section');
var indexSection = document.querySelector('#index'); // adding scroll-padding-top

document.documentElement.style.setProperty('--scroll-padding', header.offsetHeight + 50 + 'px'); // adding backgroun color on header when scroll

window.addEventListener('scroll', function () {
  window.scrollY > 10 ? header.classList.add('header-bg') : header.classList.remove('header-bg'); // detect what section is on the screen
  ...
  sections.forEach(function (section) {
    ...
    if (window.scrollY > indexSection.offsetTop + indexSection.offsetHeight) {
      if (position.top < window.innerHeight && position.bottom >= 0) {
        ...
        var activeLink = document.querySelector("a[href=\"#".concat(id, "\"]"));
        navLinks.forEach(function (navLink) {
          return navLink.classList.remove('nav-active');
        });
...
if (hamburger) {
  hamburger.addEventListener('click', function () {
    if (hamburgerOpen) {
      ...
      nav.classList.remove('open');
      navList.forEach(function (list) {
        return list.classList.remove('move');
      });
      document.body.classList.remove('no-scroll');
      hamburgerOpen = true;
    }
...
/******/ })()
;
//# sourceMappingURL=main.e786437baca498fad842.js.map